...
Version  : 0.931
Release  : 74
URL      : https://github.com/python/mypy/archive/v0.931/mypy-0.931.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.931/mypy-0.931.tar.gz
...
%prep
%setup -q -n mypy-0.931
cd %{_builddir}/mypy-0.931
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644441950
...
cp %{_builddir}/mypy-0.931/LICENSE %{buildroot}/usr/share/package-licenses/mypy/e0cb113d169cca1d35fb2efb1a824a1fa357e566
cp %{_builddir}/mypy-0.931/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.931/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
