...
Version  : 0.750
Release  : 33
URL      : https://github.com/python/mypy/archive/v0.750/mypy-0.750.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.750/mypy-0.750.tar.gz
...
%prep
%setup -q -n mypy-0.750
cd %{_builddir}/mypy-0.750
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575280207
...
cp %{_builddir}/mypy-0.750/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
