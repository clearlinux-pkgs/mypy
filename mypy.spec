...
Version  : 0.780
Release  : 41
URL      : https://github.com/python/mypy/archive/v0.780/mypy-0.780.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.780/mypy-0.780.tar.gz
...
%prep
%setup -q -n mypy-0.780
cd %{_builddir}/mypy-0.780
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591283809
...
cp %{_builddir}/mypy-0.780/LICENSE %{buildroot}/usr/share/package-licenses/mypy/33876471c1dbd7d763dd4660779fc3998c832da4
cp %{_builddir}/mypy-0.780/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
