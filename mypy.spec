...
Version  : 0.921
Release  : 69
URL      : https://github.com/python/mypy/archive/v0.921/mypy-0.921.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.921/mypy-0.921.tar.gz
...
%prep
%setup -q -n mypy-0.921
cd %{_builddir}/mypy-0.921
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640189351
...
cp %{_builddir}/mypy-0.921/LICENSE %{buildroot}/usr/share/package-licenses/mypy/e0cb113d169cca1d35fb2efb1a824a1fa357e566
cp %{_builddir}/mypy-0.921/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.921/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
