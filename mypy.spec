...
Version  : 0.960
Release  : 79
URL      : https://github.com/python/mypy/archive/v0.960/mypy-0.960.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.960/mypy-0.960.tar.gz
...
%prep
%setup -q -n mypy-0.960
cd %{_builddir}/mypy-0.960
pushd ..
cp -a mypy-0.960 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653505302
...
cp %{_builddir}/mypy-0.960/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.960/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
