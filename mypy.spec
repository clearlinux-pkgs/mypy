...
Version  : 1.1.1
Release  : 94
URL      : https://github.com/python/mypy/archive/v1.1.1/mypy-1.1.1.tar.gz
Source0  : https://github.com/python/mypy/archive/v1.1.1/mypy-1.1.1.tar.gz
...
%prep
%setup -q -n mypy-1.1.1
cd %{_builddir}/mypy-1.1.1
pushd ..
cp -a mypy-1.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678200125
