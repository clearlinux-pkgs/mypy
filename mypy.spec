...
Version  : 1.0.0
Release  : 92
URL      : https://github.com/python/mypy/archive/v1.0.0/mypy-1.0.0.tar.gz
Source0  : https://github.com/python/mypy/archive/v1.0.0/mypy-1.0.0.tar.gz
...
%prep
%setup -q -n mypy-1.0.0
cd %{_builddir}/mypy-1.0.0
pushd ..
cp -a mypy-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675731306
