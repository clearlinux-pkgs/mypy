...
Version  : 0.940
Release  : 75
URL      : https://github.com/python/mypy/archive/v0.940/mypy-0.940.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.940/mypy-0.940.tar.gz
...
%prep
%setup -q -n mypy-0.940
cd %{_builddir}/mypy-0.940
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647034869
...
cp %{_builddir}/mypy-0.940/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.940/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
