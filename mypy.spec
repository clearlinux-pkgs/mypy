...
Version  : 0.902
Release  : 58
URL      : https://github.com/python/mypy/archive/v0.902/mypy-0.902.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.902/mypy-0.902.tar.gz
...
%prep
%setup -q -n mypy-0.902
cd %{_builddir}/mypy-0.902
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623337403
...
cp %{_builddir}/mypy-0.902/LICENSE %{buildroot}/usr/share/package-licenses/mypy/e0cb113d169cca1d35fb2efb1a824a1fa357e566
cp %{_builddir}/mypy-0.902/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.902/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
