...
Version  : 0.760
Release  : 36
URL      : https://github.com/python/mypy/archive/v0.760/mypy-0.760.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.760/mypy-0.760.tar.gz
...
%prep
%setup -q -n mypy-0.760
cd %{_builddir}/mypy-0.760
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576704444
...
cp %{_builddir}/mypy-0.760/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
