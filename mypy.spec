...
%prep
%setup -q -n mypy-0.910
cd %{_builddir}/mypy-0.910
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635757094
...
cp %{_builddir}/mypy-0.910/LICENSE %{buildroot}/usr/share/package-licenses/mypy/e0cb113d169cca1d35fb2efb1a824a1fa357e566
cp %{_builddir}/mypy-0.910/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.910/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
