...
Version  : 0.990
Release  : 90
URL      : https://github.com/python/mypy/archive/v0.990/mypy-0.990.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.990/mypy-0.990.tar.gz
...
%prep
%setup -q -n mypy-0.990
cd %{_builddir}/mypy-0.990
pushd ..
cp -a mypy-0.990 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667859193
