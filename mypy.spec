...
Version  : 0.941
Release  : 76
URL      : https://github.com/python/mypy/archive/v0.941/mypy-0.941.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.941/mypy-0.941.tar.gz
...
%prep
%setup -q -n mypy-0.941
cd %{_builddir}/mypy-0.941
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647290823
...
cp %{_builddir}/mypy-0.941/LICENSE %{buildroot}/usr/share/package-licenses/mypy/2534d48fb469eec7a34d87297062d7728afdee9b
cp %{_builddir}/mypy-0.941/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.941/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
...
/usr/share/package-licenses/mypy/2534d48fb469eec7a34d87297062d7728afdee9b
