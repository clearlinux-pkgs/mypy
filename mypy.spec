...
Version  : 0.800
Release  : 51
URL      : https://github.com/python/mypy/archive/v0.800/mypy-0.800.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.800/mypy-0.800.tar.gz
...
%prep
%setup -q -n mypy-0.800
cd %{_builddir}/mypy-0.800
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611426694
...
cp %{_builddir}/mypy-0.800/LICENSE %{buildroot}/usr/share/package-licenses/mypy/33876471c1dbd7d763dd4660779fc3998c832da4
cp %{_builddir}/mypy-0.800/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
