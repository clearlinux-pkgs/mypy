...
Version  : 0.981
Release  : 86
URL      : https://github.com/python/mypy/archive/v0.981/mypy-0.981.tar.gz
Source0  : https://github.com/python/mypy/archive/v0.981/mypy-0.981.tar.gz
...
%prep
%setup -q -n mypy-0.981
cd %{_builddir}/mypy-0.981
pushd ..
cp -a mypy-0.981 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664311295
