...
%prep
%setup -q -n mypy-0.930
cd %{_builddir}/mypy-0.930
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640214819
...
cp %{_builddir}/mypy-0.930/LICENSE %{buildroot}/usr/share/package-licenses/mypy/e0cb113d169cca1d35fb2efb1a824a1fa357e566
cp %{_builddir}/mypy-0.930/mypy/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a77f6d363db008935cc2907446e3965958f3f10
cp %{_builddir}/mypy-0.930/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
