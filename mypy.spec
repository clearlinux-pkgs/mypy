...
Source0  : https://github.com/python/mypy/archive/v0.730/mypy-0.730.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571002919
...
cp %{_builddir}/mypy-0.730/mypyc/external/googletest/LICENSE %{buildroot}/usr/share/package-licenses/mypy/5a2314153eadadc69258a9429104cd11804ea304
